...
- Offline Grad-CAM is generated by `SourceCode/src/gradcam.py`.
- The Android result panel shows top-3 model probabilities to explain close alternatives on device.
